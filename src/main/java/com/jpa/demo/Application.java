...
public class Application {
    ...
    public CommandLineRunner demo(CustomerRepository repo, FuturesTester tester) {
        return (args -> {
//            repo.save(new Customer("Tarun", "Madugula", Arrays.asList(new Address("telengana", "India"))));
//            repo.save(new Customer("Amit", "Das", Arrays.asList(new Address("Odissa", "India"))));
//            repo.save(new Customer("Naveen", "Ravi", Arrays.asList(new Address("Shimoga", "India"))));
